...
import VESTING_V1 from '@/constants/abis/claim/claim_v1.json';
import VESTING_V2 from '@/constants/abis/claim/claim_v2.json';
import VESTING_V3 from '@/constants/abis/claim/claim_v3.json';
import VESTING_V4 from '@/constants/abis/claim/claim_v4.json';
import VESTING_V5 from '@/constants/abis/claim/claim_v5.json';
import VESTING_V6 from '@/constants/abis/claim/claim_fixed_refund.json';
import VESTING_V7 from '@/constants/abis/claim/claim_linear_refund.json';
import VESTING_V8 from '@/constants/abis/claim/claim_fixed_exclusive.json';
import VESTING_V9 from '@/constants/abis/claim/claim_linear_exclusive.json';
...
export const VESTING_ABIS: Record<string, any> = {
    v1: VESTING_V1,
    v2: VESTING_V2,
    v3: VESTING_V3,
    v4: VESTING_V4,
