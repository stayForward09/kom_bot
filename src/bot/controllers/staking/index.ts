...
export const menu = async (ctx: any) => {
    ...
    const [{ nativeBalance: nativeBalance_pol, komBalance: komBalance_pol, komvBalance: komvBalance_pol, komTokenPrice: komTokenPrice_pol }, maticPrice, { nativeBalance, komBalance, komvBalance, komTokenPrice }, ethPrice] = await Promise.all([
