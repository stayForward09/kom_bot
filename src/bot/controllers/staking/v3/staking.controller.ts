import { getDateAfterXDays, getKOMBalance } from '@/bot/utils'
import { calculateReward } from '@/bot/utils/staking'
...
export const callbackQuery = async (ctx: any) => {
    ...
    if (Object.keys(days).includes(selectedOption)) {
        ...
        const _reward = await calculateReward(stakingAmount, stakingPeriod)
