...
const menu = (ctx) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    yield ctx.reply('⏰ Loading your staking V2 details ...');
    ...
    const _balance = yield (0, utils_1.getStakingV2Details)(137, address);
    ...
    ctx.replyWithPhoto(pictures_1.STAKING_V2_BANNER_IMAGE, {
        caption: msg,
        parse_mode: 'HTML',
        reply_markup: {
            // force_reply: true,
