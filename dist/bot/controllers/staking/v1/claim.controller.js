...
const main_controller_2 = require("../../../../bot/controllers/staking/v1/main.controller");
...
const enterScene = (ctx) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    yield ctx.reply('⏰ Loading your stakingV1 details ...');
    ...
    ctx.reply(msg, {
        ...
        reply_markup: {
            force_reply: true,
            keyboard: [[telegraf_1.Markup.button.webApp('✔ O K', `${process.env.MINIAPP_URL}/transactions/staking/v1/unstake?chainId=137`)], [{ text: '👈 BACK' }]],
